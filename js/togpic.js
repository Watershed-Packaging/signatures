...
function swap(c) {
  ...
  const pics = [logo, logo, ab, cr, logo, dw, logo, db, logo, logo, em, logo, logo, logo, kw, logo, logo, logo, logo, logo, logo, ny, logo, logo, logo, logo, logo, rw, sbb, logo, logo, logo, logo, wk];
