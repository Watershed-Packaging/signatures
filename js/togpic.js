...
function swap(c) {
  ...
  const pics = [logo, logo, ab, cr, ch, dw, logo, logo, logo, logo, logo, kw, logo, logo, logo, logo, logo, logo, logo, ny, logo, logo, logo, logo, logo, rw, logo, sbb, logo, logo, logo, logo, wk];
